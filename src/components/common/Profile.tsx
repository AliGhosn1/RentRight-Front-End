...
const Profile = ({ type, name, avatar, email, number, address, properties }: ProfileProps) => {
    ...
    <Box>
      <Stack display='flex' flexDirection='row' justifyContent='space-between'>
        ...
        {type === 'My' &&
          ...
          icon={<Edit />}
          handleClick={() => {
              navigate(`/my-profile/edit/${user.userid}`);
          }}
        />}
      </Stack>
                  ...
                  <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                    <Stack flex={1} gap="15px">
                      ...
                      <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                        ...
                        <Typography fontSize={14} color="#11142D" noWrap>{ number }</Typography>
                      </Box>
                    </Stack>
